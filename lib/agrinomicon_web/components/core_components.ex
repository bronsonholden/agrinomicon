defmodule AgrinomiconWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AgrinomiconWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AgrinomiconWeb.Gettext, "errors", msg, opts)
    end
  end
